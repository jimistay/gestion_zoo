...
<head>
    ...
    <link rel="stylesheet" href="modifierinformationpersonel.css">
...
<header id="HautHeader">
			...
			<ul>
				...
				<li class='menu-js'><a href='#'><h4>Gestion du personnel</h4></a>
					<ul class='submenu'>
						...
						<li><a href='#'>Modification des informations d'un employé</a></li>
    ...
    <div>
        <p style="margin : 10px;">Modification d'un employé :</p>
    </div>    
    <div>
        <form action="../php/ppe4/affichageusermodify.php" method="post">
        <?php
        $_SESSION['testmod'] = 0;
        echo $_SESSION['idem'];
        ?>
