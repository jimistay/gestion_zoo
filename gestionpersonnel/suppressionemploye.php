...
<head>
    ...
    <link rel="stylesheet" href="suppressionemploye.css">
...
<header id="HautHeader">
			...
			<ul>
				...
				<li class='menu-js'><a href='#'><h4>Gestion du personnel</h4></a>
					<ul class='submenu'>
						...
						<li><a href='#'> Suppression d'un employe</a></li>
    ...
    <div>
        <p style="margin : 10px;">Supprimer un employé :</p>
    </div>    
    <div>
        <form action="../php/ppe4/deleteuserline.php" method="post">
        <?php
        $_SESSION['testmod1'] = 0;
        echo $_SESSION['idem'];
        ?>
