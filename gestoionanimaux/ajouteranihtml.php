...
<header id="HautHeader">
    ...
    <div id="menu">
        <nav>
			...
			<ul>
                ...
                <ul class="submenu">
                        <li><a href="#">Ajout d'un annimal</a></li>
    ...
    <center>
    <header>
        <h2>Gestion des animaux</h2> <br>
        <p>Ajouter un animal:</p><br>
        <p>Pour ajouter un animal veuillez remplir ce formulaire avec les informations de la personne</p>
    </header>
    <form action="../php/ppe4/animaux/registerani.php" method="post">
    <div id="nom">
    ...
    <div id="nom">
        <label for="prenom">Espèce</label>
        <?php
        echo $_SESSION['idemesp'];
        ?>
    </div>
    <div id="nom">
        <label for="comment">Commentaire</label>
        <input type="comment" id="prenomdeanimal" name="com" placeholder="" />
    </div>
    

    <div>
    <input style="cursor: pointer;" id="ajoutbouton" type="submit" value="Ajouter l'animal">
