...
<head>
    ...
    <link rel="stylesheet" href="ajoutespce.css">
...
<header id="HautHeader">
    ...
    <center>
    <header>
        <h2>Gestion des espèces</h2> <br>
        <p>Ajouter une espèce :</p><br>
        <p>Pour ajouter une espèce veuillez remplir ce formulaire avec les informations de l'espèce</p>
    </header>
    <form action="../php/ppe4/animaux/registerspe.php" method="post">
    <div id="nom">
        <label for="nom">Nom :</label>
        <input type="text" id="prenomdeanimal" name="name" placeholder="" />
    </div>
    <div id="nom">
        <label for="prenom">Espérence de Vie : </label>
        <input type="text" id="prenomdeanimal" name="lt" placeholder="" />
    </div>
    <div>
    ...
    <div>
    <input style="cursor: pointer;" id="ajoutbouton" type="submit" value="Ajouter l'espèce">
