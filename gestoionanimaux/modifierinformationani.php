...
<head>
    ...
    <link rel="stylesheet" href="modifieranimal.css">
...
<header id="HautHeader">
        ...
        <nav>
			...
			<ul>
                ...
                <ul class="submenu">
						...
						<li><a href="#">Modification des animaux</a></li>
    ...
    <center>
    <div>
        <h1 style="margin : 10px;">Gestion des animaux</h1>
    </div>
    <div>
        <p style="margin : 10px;">Modification d'un animal :</p>
    </div>    
    <div>
        <form action="../php/ppe4/animaux/affichageanimodify.php" method="post">
        <?php
        $_SESSION['testmodA'] = 0;
        echo $_SESSION['idem2A'];
        ?>

    </div>
    <input style="margin : 10px;" style="cursor: pointer;" id="ajoutbouton" type="submit" value="Modifier">
