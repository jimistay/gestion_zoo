...
<head>
    ...
    <link rel="stylesheet" href="rechercheanimal.css">
...
<header id="HautHeader">
        ...
        <nav>
			...
			<ul>
                ...
                <ul class="submenu">
						...
						<li><a href="">Recherche d'un animal</a></li>
    ...
    <div>
        <p style="margin : 10px;">Recherche des informations d'un animal :</p>
    </div>    
    <div>
        <form action="../php/ppe4/animaux/searchlineani.php" method="post">
        <?php
        $_SESSION['testmod1A'] = 0;
