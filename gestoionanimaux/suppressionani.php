...
<head>
    ...
    <link rel="stylesheet" href="supprimeranimal.css">
...
<header id="HautHeader">
    ...
    <div>
        <p style="margin : 10px;">Supprimer un animal :</p>
    </div>    
    <div>
        <form action="../php/ppe4/animaux/deleteaniline.php" method="post">
        <?php
        $_SESSION['testmod2A'] = 0;
        echo $_SESSION['idem2A'];
        ?>
    </div>
    <input style="margin : 10px;" style="cursor: pointer;" id="ajoutbouton" type="submit" value="Supprimer">
