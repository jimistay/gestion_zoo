...
<head>
    ...
    <link rel="stylesheet" href="../../css/tplogin/affichageelevesearch.css">
...
<section>
    ...
    <table border="1" style="color:white;">
        ...
        <tr>
            ...
            <form method="post" action="searchlineeleve.php">
            <td>
                <?php
                echo"<a style='color: white; background-color: green; font-weight: bold; text-decoration: none; border : 2px solid green;' href='searchlineeleve.php?num_eleve=".$enreg['num_eleve']."''>Rechercher</a>";
                ?>
            </td>
            </form>
        </tr>
